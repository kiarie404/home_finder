<?php
    ...
    // else if $row has data ... fill our variables accordingly
      elseif (count($row) > 0 ) {
        ...
        populate_buyer_filters_table_with_values($row , $buyer_filters_table);
        // test
        // echo "<br>this is when am setting initial values...<br>";
        // print_data_in_buyer_filters_table($buyer_filters_table);
      }

      // conducting test.
        // check_what_values_pseudo_database_variables_have($filters_table, $buyer_filters_table);
