      ...
      /**********************************************************************/
        function inject_first_time_settings_to_database($conn, &$filters_table)
        {
          ...
          $sql_stmt = "INSERT INTO filters
            ...
            // executing sql.
                ...
                $user_filters_table["filter_id"] = $filters_table["filter_id"];
                $user_filters_table["user_id"] = $_SESSION['user_id'];

            // building custom variables because working with arrrays is buggy. php meeeh.

                $user_id =  $user_filters_table["user_id"] ;
                $filter_id = $user_filters_table["filter_id"]  ;
          $sql_stmt = "INSERT INTO unregistered_users_filters_relation
                       (user_id, filter_id)
        ...
        //**************************************************************************************//
         // fucntion checks if the user has changed the previous settings.
          ...
          /**********************************************************************************************/
            function print_data_in_user_filters_table($user_filters_table){
              echo "/------ data in user_filters_table ----------/";
