...
if ($air_conditioning == 1) { $air_conditioning = "Available";  } else {  $air_conditioning = "Unavailable";  }
if ($water_system == 1) { $water_system = "Available";  } else {  $water_system = "Unavailable";  }
