<?php
  ...
  //consider $_SESSION['property_list'] has ids of properties in an array //
  for ($i=0; $i < count($_SESSION['property_list']) ; $i++) {  //

      $property_id = $_SESSION['property_list'][$i];   //acquitting the property_id in the array//
