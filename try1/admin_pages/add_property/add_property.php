...
<?php include 'add_property.inc.php'; ?>
  ...
  <div class="form_container" id="box5">
    ...
    <div class="panel">
      <div class="panel_element">
        ...
        <select  name="property_type" value= "<?php echo $property_type ; ?>" required>
      ...
      <div class="panel_element">
        ...
        <select  name="county" value= "<?php echo $county ; ?>" required>
      ...
      <div class="panel_element">
        ...
        <input type="text" name="estate" value= "<?php echo $estate ; ?>" required >
      ...
      <div class="panel_element" id="description">
        ...
        <textarea name="description" rows="8" cols="80"
          placeholder="write a brief description or any house special features ... (optional...)"
    ...
    <div class="panel">
      ...
      <div class="panel_element">
        ...
        <input type="number" name="rooms_number" value= "<?php echo $rooms_number ; ?>" required >
        <div class="error"> <?php echo $rooms_err;?></div>
      </div>

      <div class="panel_element">
        <label for="bedrooms_number">Number of bedrooms : </label>
        <input type="number" name="bedrooms_number" value= "<?php echo $bedrooms_number ; ?>" required >
        <div class="error"> <?php echo $bedrooms_err;?></div>
      </div>

      <div class="panel_element">
        <label for="bathrooms_number">Number of bathrooms : </label>
        <input type="number" name="bathrooms_number" value= "<?php echo $bathrooms_number ; ?>"required >
      ...
      <div class="panel_element">
        ...
        <input type="checkbox" name="water_system">
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div class="panel_element">
        ...
        <select  name="roof_type" value= "<?php echo $roof_type ; ?>" required>
      ...
      <div class="panel_element">
        ...
        <input type="number" name="pools_number" required >
        <div class="error"> <?php echo $pools_err;?></div>
      </div>

      <div class="panel_element">
        <label for="garages_number">Garages number: </label>
        <input type="number" name="garages_number" required >
    ...
    <div class="panel">
      ...
      <div class="panel_element">
        ...
        <div class="error"> <?php echo $pic1_err;?></div>
        <div class="caption"> <?php echo $pic1_caption;?></div>
      </div>

      <div class="panel_element">
        <input type="file" name="pic2" >
        <div class="error"> <?php echo $pic2_err;?></div>
        <div class="caption"> <?php echo $pic2_caption;?></div>
      </div>
